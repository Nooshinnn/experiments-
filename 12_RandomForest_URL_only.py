...
def extract_hannousse_style_url_features(url):
    # ... (same lexical feature function as before - kept unchanged for brevity)
    ...
    # ... full function body (same as your previous version)
    parsed = urlparse(url)
    hostname = parsed.hostname or ''
    path = parsed.path or ''
    f = { ... }   # Keep your original feature extraction logic here
    return f
...
def compute_all_metrics(y_true, y_pred, y_prob=None):
    ...
    metrics = { ... }  # Keep your full metrics function
    return metrics
...
# Final average results (same as before)
