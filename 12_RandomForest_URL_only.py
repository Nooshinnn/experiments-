...
print("="*80)
print("RandomForest (URL-only) - 10-Fold CV")
print("="*80)
...
print("Extracting lexical features for URL-only RandomForest...")
...
# ====================== 10-FOLD TRAINING (RandomForest URL-only) ======================
...
for fold, (train_idx, val_idx) in enumerate(kf.split(df)):
    ...
    # Train RandomForest on lexical URL features only
