...
for fold, (train_idx, val_idx) in enumerate(kf.split(df)):
    ...
    email_model = RoBERTaWrapper().to(device)
...
result_df.to_csv("17_RoBERTa_Email_only_results.csv", index=False)
print("\nResults saved to 17_RoBERTa_Email_only_results.csv")
