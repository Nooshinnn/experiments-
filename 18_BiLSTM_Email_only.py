...
class BiLSTM(nn.Module):
    def __init__(self, vocab_size=30522, embed_dim=300, hidden_dim=256, num_layers=2, dropout=0.3):
        ...
        self.fc = nn.Linear(hidden_dim * 2, 128)  # *2 for bidirectional
...
result_df.to_csv("18_BiLSTM_Email_only_results.csv", index=False)
print("\nResults saved to 18_BiLSTM_Email_only_results.csv")
