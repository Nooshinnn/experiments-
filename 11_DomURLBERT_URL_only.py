...
# ====================== 10-FOLD TRAINING (DomURLBERT URL-only) ======================
...
result_df.to_csv("11_DomURLBERT_URL_only_results.csv", index=False)
print("\nResults saved to 11_DomURLBERT_URL_only_results.csv")
