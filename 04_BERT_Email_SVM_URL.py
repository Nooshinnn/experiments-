...
for fold, (train_idx, val_idx) in enumerate(kf.split(df)):
    ...
    # ====================== EVALUATION (SVM on lexical features) ======================
    email_model.eval()
...
print(f"\nFinal Average for BERT (Email) + SVM (URL):")
...
result_df.to_csv("04_BERT_Email_SVM_URL_results.csv", index=False)
print("\nResults saved to 04_BERT_Email_SVM_URL_results.csv")
