# File: Stage2_TextCNN_Email_TextCNN_URL_OneStyle.py
import pandas as pd
import re
import torch
...
result_df.to_csv(f"Stage2_TextCNN_Email_TextCNN_URL_{communication_name.replace(' ', '_')}_results.csv", index=False)
print(f"\nResults saved to Stage2_TextCNN_Email_TextCNN_URL_{communication_name.replace(' ', '_')}_results.csv")
