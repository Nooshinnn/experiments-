# File: 60_5Fold_Naser_Phishing_Dataset.py
import pandas as pd
import torch
...
print("="*160)
print("5-FOLD CV - NASER ABDULLAH ALAM PHISHING EMAIL DATASET")
print("="*160)

# Model classes (copy from Script 59 - same as above)
# ====================== MODEL ======================
...
# Load Naser Dataset
df = pd.read_csv("phishing_email_dataset.csv")   # ← Change to your actual file name
df = df.rename(columns={"email": "email_text", "label": "label"})  # Adjust if column names differ
...
# The rest of the code is identical to Script 59 (5-Fold loop, saving, plots)
# Copy the entire 5-Fold section from Script 59 here
# 5-Fold
