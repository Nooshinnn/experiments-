# File: 07_DistilBERT_Email_XGBoost_URL.py
import pandas as pd
import re
import torch
...
for fold, (train_idx, val_idx) in enumerate(kf.split(df)):
    ...
    # ====================== EVALUATION (XGBoost on lexical features only) ======================
    email_model.eval()
...
print(f"\nFinal Average for DistilBERT (Email) + XGBoost (URL):")
...
result_df.to_csv("07_DistilBERT_Email_XGBoost_URL_results.csv", index=False)
print("\nResults saved to 07_DistilBERT_Email_XGBoost_URL_results.csv")
